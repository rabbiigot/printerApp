...
const QRMethod = () => {
  ...
  const handleFileSelect = async (file: string) => {
    const path = `http://localhost:5000/pdfs/${file}`
    setFile(path);
    setFileName(file);
  ...
  return (
    <div style={{background: "#5686e7", height:"100%", width: "100%", position: "absolute"}}>
        ...
        {file!=="" ? (
            ...
            <div>
                <h4 style={{width: "80px", zIndex: "11",top: "115px", left: "225px", background:"rgb(37, 37, 100)", color: "white", borderRadius: "5px", padding: "5px", position: "absolute"}}>Scan Me</h4>
                <img src={QR} alt="qrcode" style={{zIndex: "10",position: "absolute", border:"5px solid rgb(37, 37, 100)",background: "white", borderRadius: "5px", padding: "20px", top: "150px", left: "150px", height: "200px", width: "200px"}}/>
                <div style={{position: "absolute", color: "white", top:"450px", left: "145px", borderRadius: "5px", outline: "1px solid white", padding: "20px 60px 10px 50px" }}>
